...
const SECTIONS = [
  { id: 'ai', title: 'Lorem', theme: 'dark' },
  { id: 'autoscaling', title: 'Ipsum Dolor', theme: 'light' },
  { id: 'branching', title: 'Sit Amet', theme: 'dark' },
  { id: 'auth', title: 'Consectetur', theme: 'dark' },
  { id: 'features', title: 'Adipiscing Elit', theme: 'dark' },
];
