...
const BackedBy = () => (
  <section
    id="backed-by-giants"
    className="backed-by relative overflow-hidden bg-[#E4F1EB] pt-40 safe-paddings pb-[168px] text-black-pure xl:py-[136px] lg:py-[88px] md:py-14"
  >
    <Container className="z-10" size="1344">
      <div className="relative z-10 flex gap-16 xl:gap-[108px] lg:gap-8 md:gap-5 md:p-0 sm:flex-col sm:gap-20">
        <div className="flex-1 border-l border-gray-new-50 px-8 xl:pr-0 xl:pl-6 lg:pl-[18px] sm:border-none sm:pl-0">
          <SectionLabel className="mb-5 md:mb-4">Lorem ipsum dolor</SectionLabel>
          <h2
            className={cn(
          ...
          >
            <strong>Lorem ipsum dolor sit amet.</strong> Consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua enim ad minim veniam.
          </h2>
        ...
        >
          <SectionLabel className="md:mb-4">Sit amet consectetur</SectionLabel>
          <Quotes />
        </div>
      </div>
    </Container>
    <Image
      className="pointer-events-none absolute top-0 -right-[10%] h-full 2xl:-right-[20%] sm:-right-1/2"
      src={bgNoise}
      alt=""
      width={1175}
      height={927}
