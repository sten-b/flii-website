        ...
        <div className="flex max-w-xl flex-1 flex-col gap-10 xl:max-w-[460px] lg:max-w-full md:gap-8">
          <div className="flex flex-col lg:max-w-[448px]">
            <span className="mb-[18px] text-sm leading-none tracking-wide text-gray-new-50 uppercase lg:mb-3.5 lg:text-xs">
              Neon Service Program
            </span>
            <h1 className="w-fit font-title text-[56px] leading-none font-medium tracking-extra-tight xl:text-[48px] lg:text-[40px] md:text-[32px]">
              Launch faster with
            ...
            <p className="mt-4 text-lg leading-snug tracking-extra-tight text-balance text-gray-new-80 xl:text-base lg:mt-3.5 md:mt-3 md:text-[15px]">
              Join the Service Program and start building with the best backend for developers:
