...
const CARDS = [
  {
    title: 'Who can apply?',
    description: 'Early-stage, venture-backed services with at least $1M in funding.',
    features: [
    ...
    className: 'bg-services-info-card-1',
  },
  {
    title: 'What do you get?',
    description:
      'Credits, expert support, and visibility to help your service grow faster with Neon.',
    features: [
    ...
    className: 'bg-services-info-card-2',
  },
  {
    title: 'How to apply?',
    description:
    ...
    isWide: true,
    className: 'bg-services-info-card-3',
  },
];
